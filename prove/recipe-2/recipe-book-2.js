...
function recipeTemplate(recipe) {
  return `
    <section class="recipe" aria-label="${recipe.name} recipe card">
      ...
      <div class="recipe__content">
        ...
        <div class="recipe__meta">
          ...
          <span class="recipe__time">${recipe.cookTime}</span>
          <span class="recipe__servings">${recipe.recipeYield}</span>
        </div>
        ...
        <a class="recipe__link" href="${recipe.url || '#'}">View Recipe</a>
      </div>
    </section>
  `;
}
